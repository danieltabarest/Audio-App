...
namespace AudioApp.Services
{
    public class ApiService
    {
        ...
        public async Task<Response> ChangePassword(string urlBase, string servicePrefix, string controller, string tokenType, string accessToken, ChangePasswordRequest model)
        {
            try
            {
                var request = JsonConvert.SerializeObject(model);
